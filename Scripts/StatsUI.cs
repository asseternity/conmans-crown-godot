...
public partial class StatsUI : Control
{
	...
	private ColorRect _currentLore;
	private ColorRect _maxLore;
	...
	public override void _Ready()
	{
		...
		_loreLabel = GetNode<Label>("Panel/VBoxContainer/MaxLore/LoreLabel");
		...
		_maxLore = GetNode<ColorRect>("Panel/VBoxContainer/MaxLore");
		_currentLore = GetNode<ColorRect>("Panel/VBoxContainer/MaxLore/CurrentLore");
	...
	public void OnShowStats()
	{
		...
		_loreLabel.Text = $"Lore: {player.Lore}";
		...
		SetBarWidth(_currentLore, _maxLore, player.Lore ?? 0, 20);
